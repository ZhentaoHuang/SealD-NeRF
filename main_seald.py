...
from SealDNeRF.provider import NeRFDataset
from SealDNeRF.gui import NeRFGUI
from SealDNeRF.utils import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--teacher_workspace', type=str, default='teacher_workspace')
    parser.add_argument('--seed', type=int, default=0)

    ### training options
    parser.add_argument('--iters', type=int, default=30000, help="training iters")
    parser.add_argument('--lr', type=float, default=5e-4, help="initial learning rate")
    parser.add_argument('--lr_net', type=float, default=5e-5, help="initial learning rate")
    ...
    parser.add_argument('--bg_radius', type=float, default=-1, help="if positive, use a background model at sphere(bg_radius)")
     ...
     # seal options
    parser.add_argument('--seal_config', type=str, default='data/seal/lego/bbox/')
    ...
    parser.add_argument('--max_spp', type=int, default=64, help="GUI rendering max sample per pixel") #zhentao: initially set to 64
    ...
    if opt.basis:
        ...
        from SealDNeRF.network_hyper import NeRFNetwork
    else:
        from SealDNeRF.network import NeRFNetwork
